...
type SimpleInterfaceProperties struct {
    PropBool *bool `json:"propBool,omitempty"`
    PropInt *int64 `json:"propInt,omitempty"`
    PropFloat *float64 `json:"propFloat,omitempty"`
...
type SimpleArrayInterfaceProperties struct {
    PropBool *[]bool `json:"propBool,omitempty"`
    PropInt *[]int64 `json:"propInt,omitempty"`
    PropFloat *[]float64 `json:"propFloat,omitempty"`
    PropString *[]string `json:"propString,omitempty"`
